...
RSpec.feature 'Viewing a project', type: :feature do
  ...
  context 'with related data' do
    ...
    scenario 'shows the project tasks' do
      task1 = @project1.tasks.create(name: 'Task one', due_date: '2016-07-01')
      task2 = @project1.tasks.create(name: 'Task two', due_date: '2016-07-01')
      task3 = @project1.tasks.create(name: 'Task three', due_date: '2016-07-01')
    ...
    scenario 'shows the project assignments' do 
